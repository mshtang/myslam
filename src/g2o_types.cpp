...
//     Vector3d xyz = point->estimate();
//     Vector3d xyz_trans = T.map(point_);
//     double x = xyz_trans.x();
//     double y = xyz_trans.y();
//     double z = xyz_trans.z();
//     double z2 = z * z;

//     _jacobianOplusXi(0, 0) = x * y / z2 * camera_->fx_;
//     _jacobianOplusXi(0, 1) = -(1 + (x * x) / z2) * camera_->fx_;
//     _jacobianOplusXi(0, 2) = y / z * camera_->fx_;
//     _jacobianOplusXi(0, 3) = -1. / z * camera_->fx_;
//     _jacobianOplusXi(0, 4) = 0;
//     _jacobianOplusXi(0, 5) = x / z2 * camera_->fx_;
//     _jacobianOplusXi(1, 0) = (1 + y * y / z2) * camera_->fy_;
//     _jacobianOplusXi(1, 1) = -x * y / z2 * camera_->fy_;
//     _jacobianOplusXi(1, 2) = -x / z * camera_->fy_;
//     _jacobianOplusXi(1, 3) = 0;
//     _jacobianOplusXi(1, 4) = -1. / z * camera_->fy_;
//     _jacobianOplusXi(1, 5) = y / z2 * camera_->fy_;
// }
// } // namespace myslam
